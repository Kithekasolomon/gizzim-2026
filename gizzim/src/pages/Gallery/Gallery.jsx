                        ...
                        <ul className="flex space-x-10">
                            {navLinks.map((link) => (
                                <li key={link.name}>
                                    <Link
                                        to={link.path}
                                        className={`text-stone-200 hover:text-amber-600 transition-colors duration-300 font-medium tracking-wide text-sm uppercase ${link.name === 'Gallery' ? 'text-amber-600' : ''
                                            }`}
                                    >
                                        {link.name}
                                    </Link>
